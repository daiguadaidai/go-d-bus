...
type Task struct {
	...
	ChecksumParaller     sql.NullInt64  `gorm:"column:checksum_paraller;not null;default:1"`                                       //应用binlog 并发数
	ChecksumFixParaller  sql.NullInt64  `gorm:"column:checksum_fix_paraller;not null;default:1"`                                       //应用binlog 并发数
}
